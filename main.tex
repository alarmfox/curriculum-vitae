...
\renewcommand{\maketitle}
{
  ...
  \paragraph{Course contents} Activities focused on:
  \begin{itemize}
    \item Cloud security: focus on Azure and Bicep to create a secure cloud environment including network profiles and trusted VMs
  \end{itemize}
